	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if episodeMode {
			if inputIsRange {
				...
				return handler.HandlerSetEpisodeRangeWatched(cmd.Context(), s, showTitle,
					startNums, endNums)
			} else {
				...
				return handler.HandlerSetEpisodeWatched(cmd.Context(), s, showTitle,
			...
			if inputIsRange {
				...
				return handler.HandlerSetSeasonRangeFinished(cmd.Context(), s, showTitle,
					startSeasonNumber, endSeasonNumber)
			} else {
				...
				return handler.HandlerSetSeasonFinished(cmd.Context(), s, showTitle, seasonNumber)
			}
		}
	},
}
